    ...
    Uint32 storageTextureCount)
{
  ...
  shaderInfo.code = (const Uint8 *)spirvBytecode;
...
SDL_AppResult SDL_AppInit(void **appstate, int argc, char **argv)
{
  ...
  SDL_GPUGraphicsPipelineCreateInfo pipelineCreateInfo = {
      ...
      .target_info = {
          .color_target_descriptions = (SDL_GPUColorTargetDescription[]){{.format = SDL_GetGPUSwapchainTextureFormat(gpuDevice, window)}},
          .num_color_targets = 1,
      }};
